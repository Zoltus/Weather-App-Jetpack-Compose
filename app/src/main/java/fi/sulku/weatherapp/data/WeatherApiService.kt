...
object WeatherApiService {
    ...
    private fun createUrl(location: Location) : String {
        return "https://open-meteo.com/en/docs#latitude=${location.latitude}&longitude=${location.longitude}&current=temperature_2m,relative_humidity_2m,apparent_temperature,precipitation,weather_code,wind_speed_10m&minutely_15=&hourly=temperature_2m,apparent_temperature,weather_code&daily=weather_code,temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max,precipitation_sum,precipitation_probability_max&timezone=Europe%2FLondon&past_days=1&forecast_days=14&models="
    }
}
